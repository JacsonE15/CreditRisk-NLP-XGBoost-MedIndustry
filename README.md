# Med-CreditRisk-NLP-FinBERT-XGB

Predicting ST (Special Treatment) risk for A-share listed pharmaceutical companies using financial statement data and FinBERT-based NLP sentiment analysis of annual report narratives.
